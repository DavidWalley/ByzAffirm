...
console.log("**40 ByzTest.js running under NODE");
...
ByzTest.prototype._bRenew = function(a_asNodeNames) {
  ...
  console.log("**41 Start All.");
  me._ConsoleShowAll();
  setTimeout(function() {
    console.log('**42 Ann creates "Data1".');
...
ByzTest.prototype._ConsoleShowAll = function() {
  ...
  for (var i = 0; i < n; i++) {
    console.log("**43 Logs at node " + i + ": " + me._anodeserverAll[i].sListOfMyLogs());
  }
  return true;
};
